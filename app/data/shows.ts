export const shows = [
    {
      title: 'The Notebook',
      description: "The musical adaptation of Nicholas Sparks' novel comes to Broadway, featuring music by Ingrid Michaelson.",
    ...
    },
    {
      ...
      description: "Kelli O'Hara and Brian d'Arcy James star in the Broadway premiere of Adam Guettel and Craig Lucas' new musical.",
